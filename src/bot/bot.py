...
text_messages = {
    ...
    'cr_still_looking': 'Мы все еще ищем вам пару 🥲 Как только найдем, но пришлем сообщение с никнеймом вашего партнера',
    'cr_cant_find_you': 'Мы не можем найти вашу заявку, попробуйте подать ее еще раз через форму подачи',

    'ar_by_partner': 'Ваш партнер отменил заявку, но мы постараемся найти вам новую пару как можно скорее',
    'ar_successfully': 'Ваша заявка успешно отменена',

    'wrong_usr': 'Похоже, что вы ввели что-то не то; Попробуйте начать заново с помощью команды /start',
    'wrong_srv': 'Похоже что-то пошло не так. Пожалуйста, попробуйте еще раз'
}
